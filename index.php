                        ...
                        <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post" role="form" class="contactForm">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" required class="form-control" id="inputLastName" name="sobrenome" placeholder="Sobrenome">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputDate">Nascimento *</label>
                                    <input type="date" required class="form-control" name="data" id="inputDate" placeholder="Data de Nascimento">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" required class="form-control mascara-cpfcnpj" name="CPF">
                                </div>
                                
                                <div class="form-group col-md-6">
                                    <label for="inputGender">Sexo *</label>
                                    <select id="inputGender" class="form-control" name="sexo" placeholder="Sexo">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="telefone" required id="inputTelephone">
                                </div>
